...
/*----------------------------------------------------*/
    ...
    $("#contact form").submit(function() {
        ...
        var rsForm = $(this).closest('#contact-form');
        oForm.form = $('#contact-form');
        ...
        var rsFormName = rsForm.find("[name='contact-name']");
        oForm.name = oForm.form.find("[name='contact-name']");
        var rsFormEmail = rsForm.find("[name='contact-email']");
        oForm.email = oForm.form.find("[name='contact-email']");
        oForm.subject = oForm.form.find("[name='contact-subject']");
        var rsFormMessage = rsForm.find("[name='contact-message']");		
        oForm.message = oForm.form.find("[name='contact-message']");
        
        
        console.log(oForm);
        $.ajax({
            url: "http://formspree.io/ronnie@ronniehallvocalstudio.com", 
            type: "POST",
...
function sendMessage(e) {                  
        ...
        var dto = {name:oForm.name.val(),email:oForm.email.val(),subject:oForm.subject.val(),message: oForm.message.val()};
